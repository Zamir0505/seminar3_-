...
* ## Создание в удаленной репозитории ветку, соответствующей локальной и их связка.
...
## Клонирование внешнего репозитария на локальный пк
...
Такой запрос называется ***pull request***.
